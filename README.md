About r-assertive.data.uk-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-assertive.data.uk-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=968&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-assertive.data.uk-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-assertive.data.uk` can be installed with `conda`:
...
```
mamba install r-assertive.data.uk
```

It is possible to list all of the versions of `r-assertive.data.uk` available on your platform with `conda`:
...
```
mamba search r-assertive.data.uk --channel conda-forge
```
...
mamba repoquery search r-assertive.data.uk --channel conda-forge

# List packages depending on `r-assertive.data.uk`:
mamba repoquery whoneeds r-assertive.data.uk --channel conda-forge

# List dependencies of `r-assertive.data.uk`:
mamba repoquery depends r-assertive.data.uk --channel conda-forge
```
